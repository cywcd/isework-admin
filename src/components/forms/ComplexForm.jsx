...
import {
  Form, Select, InputNumber, Switch, Radio, Slider,  Button, Upload, Icon, Rate, Checkbox, Card, Row, Col } from 'antd';
  ...
  render() {
    ...
    return (
      <div className="gutter-example">
            <BreadcrumbComon first="表单" second="复杂表单" />
            <Row gutter={16}>
              <Col className="gutter-row" md={24}>
                  <div className="gutter-box">
                      <Card title="多组件复杂表单" bordered={false}>
